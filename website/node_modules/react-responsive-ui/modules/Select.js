		...
		value: function render_selected_item_only(label_is_shown) {
			...
			if (autocomplete && expanded) {
				...
				return React.createElement('input', {
					...
					tabIndex: tabIndex,
					title: title,
					className: classNames(selected_style_classes, 'rrui__input-field', 'rrui__text-input__input', 'rrui__select__autocomplete', inputClassName) });
			}
			...
			return React.createElement(
				'button',
				{
					...
					className: classNames(selected_style_classes, 'rrui__select__button', {
