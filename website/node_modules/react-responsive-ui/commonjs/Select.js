				...
				_react2.default.createElement(
					...
					show_options_list && expanded && closeButton && _react2.default.createElement(
						'button',
						{
							...
							className: (0, _classnames2.default)('rrui__select__close', {
		...
		value: function render_selected_item_only(label_is_shown) {
			...
			if (autocomplete && expanded) {
				...
				return _react2.default.createElement('input', {
					...
					tabIndex: tabIndex,
					title: title,
					className: (0, _classnames2.default)(selected_style_classes, 'rrui__input-field', 'rrui__text-input__input', 'rrui__select__autocomplete', inputClassName) });
			}
			...
			return _react2.default.createElement(
				'button',
				{
					...
					className: (0, _classnames2.default)(selected_style_classes, 'rrui__select__button', {
