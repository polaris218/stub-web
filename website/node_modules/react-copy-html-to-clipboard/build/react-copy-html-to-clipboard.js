...
var _copyHtmlToClipboard = __webpack_require__(2);

var _copyHtmlToClipboard2 = _interopRequireDefault(_copyHtmlToClipboard);
...
var CopyToClipboard = exports.CopyToClipboard = function (_React$PureComponent) {
  ...
  function CopyToClipboard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CopyToClipboard.__proto__ || Object.getPrototypeOf(CopyToClipboard)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (event) {
      ...
      if (typeof text == 'function') textToCopy = text();else textToCopy = text;

      var result = (0, _copyHtmlToClipboard2.default)(textToCopy, options);
  ...
  _createClass(CopyToClipboard, [{
    ...
    value: function render() {
      ...
      return _react2.default.cloneElement(elem, _extends({}, props, { onClick: this.onClick, onTouchTap: this.onClick }));
    }
  }]);
...
//# sourceMappingURL=react-copy-html-to-clipboard.js.map