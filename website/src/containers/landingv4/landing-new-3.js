...
import landingPageDataLandingNew3 from '../../landingv2-data.json';
...
export default class LandingNew3 extends LandingNew {
  ...
  render() {
    ...
    return (
      <div className={styles['full-height']}>
        <DefaultHelmet/>
        <div className={cx(styles['page-wrap'], styles['newLandingFont'])}>
          <LandingNavigationV2 data={landingPageData} />
          <section className={styles['header'] + ' ' + styles['landing-v3']}>
            <div className={styles['container'] + ' ' + styles['girl_bg']}>
              ...
              <div className={styles['button-group']}><a href={'/book-demo'} className={'blue-btn ' + styles['btn']}>Book Demo</a><a href={'/signup'} className={'green-btn primary-action-btn ' + styles['btn'] + ' ' + styles['no-credit-needed']}>Try for free</a></div>
            </div>
          </section>
              ...
              <div className={styles['container']}>
                <Row>
                  <Col xs={12} sm={6} className={styles['texts']}>
                    ...
                    <a href={'/thesecretsauce'} className={'green-btn primary-action-btn ' + styles['btn']}>Download for Free</a>
                  </Col>
        ...
        <Footer3v data={landingPageDataLandingNew3} />
