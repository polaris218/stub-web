...
class Footer3v extends Component {
            ...
            if (item && i == 0) {
                ...
                return (
                    <Col className={styles["footerColmn"]} xs={6} sm={3} md={3} lg={2}>
                        ...
                        <div className={cx(styles["footerItems"], styles["footerItemsNew"])}>
    ...
    render() {
        ...
        return (<section className={cx(styles['footer'], styles['footer-new'])}>
                    <Grid>
                        <Row>
                            <Col className={styles["footerColmn"]} xs={6} sm={4} md={4} lg={3}>
                                <Link to="/">
                                    <img className={styles['navbar__brand-image']} src="/images/lending/Group-210-2.png" alt="Logo" />
                                </Link>
