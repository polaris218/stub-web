...
import styles from './slim-footerv2.module.scss';
import FontAwesomeIcon from '@fortawesome/react-fontawesome';
import { faTwitter, faFacebookF, faLinkedinIn } from '@fortawesome/fontawesome-free-brands';
import { faPhone, faEnvelope } from '@fortawesome/fontawesome-free-solid';
import { Link } from 'react-router-dom';

export default class SlimFooterV2 extends Component {
  constructor(props) {
    super(props);
