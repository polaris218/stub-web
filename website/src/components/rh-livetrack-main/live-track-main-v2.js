...
export default class RHLiveTrackMain extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className={styles.liveTrackMainContainer}>
        ...
        <Rating
          ...
          rate={(rating, text) => this.postRate(rating, text)}
        ...
        <div className={styles.liveTrackMainFlexContainer}>
          ...
          <div className={cx(styles.customColumn, styles.taskItemsColumn, 'col-md-12')}>
            <div className="row">
              <div className="col-lg-6 col-md-12">
                ...
                <TaskProducts products={items_with_statuses} slidesToShow={3} slidesToScroll={3} page="rh"/>
              </div>
            </div>
          </div>
          }
          ...
          <div style={{ height: mapHeight }} className={cx(styles.customColumn, styles.locationMapColumns, 'col-md-6')}>
